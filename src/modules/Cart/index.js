            ...
            carts?.map(cart => {
              return (
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                  ...
                  <span className="text-center w-1/5 font-semibold text-sm">₹{cart?.price*83}</span>
                  <span className="text-center w-1/5 font-semibold text-sm">₹{cart?.price *83* cart?.quantity}</span>
                </div>
              )
            })
          }
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div>
            ...
            <select className="block p-2 text-gray-600 w-full text-sm">
              <option>Standard shipping - ₹250.00</option>
            </select>
          </div>
          <div className="py-10">
